...
Investigate if there are other such cases. -> there are
...
```{r}
# Assuming not_matched is obtained as described before
...
# Print or use the unique_not_matched dataframe as needed
print(unique_not_matched)
