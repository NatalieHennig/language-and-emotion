...
frequency_whole <- read.csv(here("01_data", "whole_frequency_list.csv"))
frequency_spoken <- read.csv(here("01_data", "spoken_frequency_list.csv"))
frequency_written <- read.csv(here("01_data", "written_frequency_list.csv"))
```
...
```{r get_all_unique_missing_frequencies}
...
```{r get_existing_missing_frequencies}
...
```{r merge_manual_frequencies_to_main}
