...
frequency_whole <- read.csv(here("01_data", "frequency", "mapped_pos_frequency.csv"))
...
eye_table <- anti_join(eye_table, not_matched, by = c("token.lower" = "Word")) 
```
...
(sum(eye_table$frequency==0)/length(eye_table$frequency))*100
